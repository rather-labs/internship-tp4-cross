    ...
    return (
      <div className="space-y-4">
        {playerCount === 1 ? (
          ...
          <div className="ml-6 flex items-center justify-center gap-2">
            <button className="bg-[#BBC0C5] px-8 py-4 rounded-xl text-xl font-bold cursor-not-allowed opacity-75" disabled={true}>
      ...
      <main className="container mx-auto px-4 py-16 text-center">
        <div className="max-w-3xl mx-auto bg-white rounded-2xl shadow-xl p-8 mb-12">
          ...
          <p className="text-xl text-[#6A737D] mb-8 max-w-2xl mx-auto">
            Challenge players from different blockchain networks in this classic game.
          </p>
          ...
          {account.status === 'connected' as const ? (
            ...
            <div className="space-y-4">
              ...
              <p className="text-[#BBC0C5]">Connect your wallet to start playing</p>
            </div>
          )}
        </div>
        ...
        <section className="grid md:grid-cols-2 gap-40">
          {[
            ...
            <div key={i} className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow">
              ...
              <a href={feature.link} className="text-[#037DD6] hover:text-[#0260A4] transition-colors">Learn More</a>
            </div>
          ))}
        </section>
